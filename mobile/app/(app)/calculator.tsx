          ...
          <View style={styles.resultCard}>
            ...
            <View style={styles.resultGrid}>
              <View style={[styles.resultBox, { backgroundColor: 'rgba(37,99,235,0.08)', borderColor: 'rgba(37,99,235,0.15)' }]}>
                ...
                <Text style={[styles.resultValue, { color: colors.primary }]}>{result.lotSize}</Text>
                <Text style={styles.resultUnit}>lots</Text>
              </View>
              <View style={[styles.resultBox, { backgroundColor: 'rgba(220,38,38,0.06)', borderColor: 'rgba(220,38,38,0.15)' }]}>
            ...
            <View style={styles.pipBox}>
              <Text style={styles.pipText}>
                Pip Value: <Text style={{ color: colors.ink, fontWeight: '700' }}>${result.pipValue}</Text> per pip per lot
              </Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  resultCard: { marginTop: spacing.md, backgroundColor: 'rgba(37,99,235,0.04)', borderWidth: 1, borderColor: 'rgba(37,99,235,0.15)', borderRadius: radius.xl, padding: 18 },
  ...
  rule: { backgroundColor: 'rgba(22,163,74,0.06)', borderWidth: 1, borderColor: 'rgba(22,163,74,0.12)', borderRadius: radius.sm, padding: 10, marginTop: 12 },
  ...
  ruleTitle: { color: colors.ink, fontWeight: '700', fontSize: font.body },
