...
const styles = StyleSheet.create({
  ...
  avatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: 'rgba(37,99,235,0.15)', alignItems: 'center', justifyContent: 'center' },
  ...
  title: { color: colors.ink, fontWeight: '800', fontSize: 18, marginBottom: 10 },
  ...
  reactBtn: { backgroundColor: colors.overlay2, borderWidth: 1, borderColor: '#e5e8ee', borderRadius: 8, paddingVertical: 6, paddingHorizontal: 14 },
  reactActiveLike: { backgroundColor: 'rgba(22,163,74,0.15)', borderColor: 'rgba(22,163,74,0.3)' },
  reactActiveDislike: { backgroundColor: 'rgba(220,38,38,0.1)', borderColor: 'rgba(220,38,38,0.3)' },
  ...
  cAvatar: { width: 30, height: 30, borderRadius: 15, backgroundColor: 'rgba(37,99,235,0.1)', alignItems: 'center', justifyContent: 'center' },
  cAvatarText: { color: colors.primary, fontWeight: '700', fontSize: 12 },
  commentBubble: { flex: 1, backgroundColor: colors.card, borderWidth: 1, borderColor: '#eef1f5', borderRadius: radius.md, padding: 10 },
  commentMeta: { flexDirection: 'row', gap: 8, alignItems: 'center', marginBottom: 4 },
  cName: { color: colors.ink, fontWeight: '700', fontSize: 12 },
  ...
  input: { flex: 1, backgroundColor: colors.overlay2, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, paddingHorizontal: 14, paddingVertical: 11, color: colors.ink },
  postBtn: { backgroundColor: colors.primary, borderRadius: radius.md, paddingHorizontal: 16, justifyContent: 'center' },
  postBtnText: { color: colors.white, fontWeight: '800' },
})
