    ...
    <Screen scroll refreshing={isRefetching} onRefresh={refetch}>
      ...
      <View style={{ padding: spacing.lg }}>
        <View style={styles.statsGrid}>
          <StatBox label="Total Earned" value={formatCurrency(data.totalEarned)} color={colors.gold} />
          ...
          <StatBox label="Total Sales" value={String(data.totalSales)} color={colors.white} />
        </View>
...
function statusColor(s: string) {
  ...
  if (s === 'APPROVED') return colors.gold
...
const styles = StyleSheet.create({
  ...
  linkBox: { backgroundColor: 'rgba(245,197,24,0.06)', borderWidth: 1, borderColor: colors.border, borderRadius: radius.sm, padding: 10 },
  linkText: { color: colors.muted, fontSize: font.small },
  smallBtn: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgba(245,197,24,0.08)', borderWidth: 1, borderColor: colors.border, borderRadius: radius.sm, paddingHorizontal: 12, paddingVertical: 7 },
  smallBtnText: { color: colors.gold, fontWeight: '700', fontSize: font.small },
  pendingBox: { backgroundColor: 'rgba(240,180,41,0.06)', borderWidth: 1, borderColor: 'rgba(240,180,41,0.2)', borderRadius: radius.lg, padding: 16, marginBottom: 14 },
  pendingText: { color: '#f0b429', fontSize: font.body },
  ...
  quickTitle: { color: colors.white, fontWeight: '700', fontSize: font.body },
  ...
  saleName: { color: colors.white, fontSize: font.body },
